          ...
          >
            <motion.div className="m-0 h-full w-full bg-zinc-50 shadow-2xl">
              <div className="h-12 flex items-center justify-between px-4 border-b border-zinc-200 bg-white">
                ...
                <div className="text-sm text-zinc-700 truncate max-w-[60%]">{name}</div>
              ...
              <div className="h-[calc(100vh-3rem)] w-full overflow-auto">
                {error ? (
                  ...
                  <div className="h-full w-full flex items-center justify-center p-4 relative">
                    ...
                    <img alt={name || "image"} src={src} className="max-w-full max-h-full rounded-lg border border-zinc-200 bg-white" onLoad={() => setFrameLoaded(true)} />
                  </div>
                ) : isPdf && src ? (
                  <div className="relative w-full h-full">
                    ...
                    <object data={src} type="application/pdf" className="w-full h-full">
                      <iframe title={name || "pdf"} src={src} className="w-full h-full" onLoad={() => setFrameLoaded(true)} />
                    </object>
                  </div>
                ) : ext === "docx" ? (
                    ...
                    <div className="w-[min(92vw,520px)] rounded-xl border border-zinc-200 bg-white shadow-soft p-4">
                      ...
                      <div className="mt-3 flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          onClick={async () => {
                            const labelSlug = currentAssoc?.labelSlug || normalizeFile(name);
                            if (!labelSlug) return;
